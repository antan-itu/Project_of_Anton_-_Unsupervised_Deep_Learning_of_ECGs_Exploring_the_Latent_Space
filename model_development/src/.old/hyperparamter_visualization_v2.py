...
CSV_PATH = "/home/akokholm/mnt/SUN-BMI-EC-AKOKHOLM/Master-BMI/GitHub_Repository/Project_of_Anton_-_Unsupervised_Deep_Learning_of_ECGs_Exploring_the_Latent_Space/model_development/experiments/experiment_summary.csv"

# Where to save the plots
OUTPUT_DIR = os.path.join(os.path.dirname(CSV_PATH), "GridSearch_Visualizations")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Updated to match the cross-validation output
TARGET_METRIC = "Avg_XGB_PRAUC"  

# List of hyperparameters (Updated to match training script output exactly)
HYPERPARAMETERS = [
    "latent_dim", "learning_rate", "base_filters", "kernel_size", 
    "num_layers", "pool_size", "pooling_type", "activation", 
    "norm_type", "dropout_rate", "batch_size", "loss_func", "masking_ratio"
]
...
plt.title("Parallel Coordinates of All Trials\n(Blue lines indicate lower Val PR-AUC)", fontsize=15)
