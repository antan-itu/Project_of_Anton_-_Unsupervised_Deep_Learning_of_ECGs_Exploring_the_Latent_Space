...
GRID_LATENT_DIMS = [32, 64]        
GRID_LEARNING_RATES = [1e-3, 1e-2]     
GRID_BASE_FILTERS = [16, 32]     
GRID_KERNEL_SIZES = [3, 5]       
...
def create_dataset(file_pattern, batch_size):
    ...
    # Cache activated for the small subset to drastically speed up training
